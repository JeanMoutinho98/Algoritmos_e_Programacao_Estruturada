...
int main(){
    ...
    char string1[10] = {'a', 'b', 'c'};                             // Primeira forma de inicializar uma string.
    // Caso não coloque \0, pode aparecer valores aleatórios na string.  
    // \0 fecha a string. 
    // \0 é um caractér de fim.
    

    char string2[10] = "def";                                       // Segunda forma de inicializar uma string.
    // Não precisa se preocupar com o \0 nessa forma.


    char string3[10];                                               // Terceira forma de inicializar uma string.
    char lixo;
    ...
    char string4[20];                                               // Quarta forma de inicializar uma string.
    
    printf("Insira uma string usando a funcao 'gets':");
    gets(string4);


    char string5[20];                                               // Quinta forma de inicializar uma string.
...
// Funções para manipular strings.
    ...
    if(strcmp(s1,s2) == 0){                                         // strcmp(elemento1, elemento2) == 0;
        printf("%s eh igual a %s\n", s1, s2);                       // A função strcmp() é case sensitive.
